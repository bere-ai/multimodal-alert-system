...
Most safety systems rely on sound—but sound is often the first thing to fail.

This project removes audio entirely and replaces it with visual and vibration-based alerts, creating a more reliable way for humans to detect and respond to critical conditions in high-risk environments like space missions, industrial workspaces, and Deaf-centered systems.
## What this is
